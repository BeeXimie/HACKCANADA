...
module.exports = function(app) {
  const hpmMiddleware = createProxyMiddleware({
    ...
    pathFilter: ['/api/auth', '/api/scholarships', '/api/user', '/api/ai', '/login', '/callback', '/logout', '/onboarding', '/onboarding_confirm', '/profile', '/recommendations', '/scholarships', '/essay', '/applied'],
